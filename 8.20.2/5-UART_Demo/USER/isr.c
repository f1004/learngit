...
int16 num,Road_Angle,Road_Angle1;
...
char Yuan_Flag,Lose_Left;


float yuan_Angle,yuan_Angle1;
int road_kp=6;
...
//
//
//	        	 yuan_Angle1=road_kp*(Road_Lenth);
//
...
//	             speed2_power=+YuanPwm+out1;
      ...
      // speed1_power=2000;
      // speed2_power=2000;
       speed_pid(encoder1,encoder2,600);
	        speed1_power = out1;
	        speed2_power = out1;
	        	    lcd_showstr(0,4,"encoder1");
	        	 	lcd_showint16(80,4 ,encoder1);
...
//    }
//    else if(icm_gyro_x!=0){
//  	  Road_Angle=Road_Angle+icm_gyro_x+14;
//    }

//    Road_Angle1=(int)(out_Kp*road);
...
//        speed1_power = out1+outpwm;
//        speed2_power = out1-outpwm;
    speed1_power = 1200;//4000 1150
    speed2_power = -50;//1000   -50
    if(road<11000)
    {

        speed1_power = 2000;//4000 1150
        speed2_power = 2000;//1000   -50
...
void Yuan(void)
{
   if(ad_value2>=120 && ad_value3>=120 && ad_value4>=120)
   {
	   yuan_flag=1;
