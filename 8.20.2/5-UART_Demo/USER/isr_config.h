...
#define ERU_CH1_CH5_INT_SERVICE 1	//定义ERU通道1和通道5中断服务类型，同上
...
#define ERU_CH3_CH7_INT_SERVICE 1	//定义ERU通道3和通道7中断服务类型，同上
...
//------------串口中断参数相关定义------------
#define	UART0_INT_SERVICE  	1//定义串口0中断服务类型，即中断是由谁响应处理 0:CPU0 1:CPU1 3:DMA  不可设置为其他值
